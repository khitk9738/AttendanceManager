package com.example.akki.genuine;
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        if(names.get(position).toString().equals("ATTENDANCE"))
        {
            ...
            Animation anim = new ScaleAnimation(
                    0.80f, 1f, // Start and end values for the X axis scaling
                    0.80f, 1f, // Start and end values for the Y axis scaling
                    Animation.RELATIVE_TO_SELF, 0.8f, // Pivot point of X scaling
                    Animation.RELATIVE_TO_SELF, 0.8f); // Pivot point of Y scaling
