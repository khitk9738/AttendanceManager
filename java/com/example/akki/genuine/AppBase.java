...
public class AppBase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        divisions.add("Faculty 1");
        divisions.add("Faculty 2");
        divisions.add("Faculty 3");
        divisions.add("Faculty 4");
        divisions.add("Faculty 5");
        divisions.add("Faculty 6");
        divisions.add("Faculty 7");
